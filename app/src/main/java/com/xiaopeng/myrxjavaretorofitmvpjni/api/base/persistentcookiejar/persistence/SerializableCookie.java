package com.xiaopeng.myrxjavaretorofitmvpjni.api.base.persistentcookiejar.persistence;
...
public class SerializableCookie implements Serializable {
    ...
    public String encode(Cookie cookie) {
        ...
        try {
            ...
            Logger.t(TAG).d( "IOException in encodeCookie", e);
            return null;
        } finally {
            if (objectOutputStream != null) {
                try {
                    ...
                    Logger.t(TAG).d("Stream not closed in encodeCookie", e);
                }
            }
        }
    ...
    public Cookie decode(String encodedCookie) {
        ...
        try {
            ...
            Logger.t(TAG).d( "IOException in decodeCookie", e);
        } catch (ClassNotFoundException e) {
            Logger.t(TAG).d( "ClassNotFoundException in decodeCookie", e);
        } finally {
            if (objectInputStream != null) {
                try {
                    objectInputStream.close();
                } catch (IOException e) {
                    Logger.t(TAG).d( "Stream not closed in decodeCookie", e);
                }
            }
        }
        return cookie;
