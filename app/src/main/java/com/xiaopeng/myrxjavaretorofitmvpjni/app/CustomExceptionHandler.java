...
//            Intent intent = new Intent(mContext,FirstWelcomActivity.class);
...
//            PendingIntent restartIntent = PendingIntent.getActivity(mContext, 0, intent,Intent.FLAG_ACTIVITY_CLEAR_TOP |
//                    Intent.FLAG_ACTIVITY_NEW_TASK);
...
//            mgr.set(AlarmManager.RTC, System.currentTimeMillis() + 100, restartIntent); // 1秒钟后重启应用
    ...
    private boolean handleException(Throwable ex) {
        ...
        Toast.makeText(mContext, "file path :" + fileName, Toast.LENGTH_LONG).show();
        return true;
    }
